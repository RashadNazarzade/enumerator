...
export type PickDictValues<Dict, DictObj = ExtractDictValues<Dict>> = Simplify<
  DictObj[keyof DictObj]
>;
...
export type DictMapToTuple<
  EnumValObj,
  Keys extends ReadonlyArray<keyof EnumValObj> | Array<keyof EnumValObj> =
    never,
> = [Keys] extends [never]
