import type { EnumerateValueMetadata, EnumerateValueWithMeta } from '@/types/base';
...
export type ExtractMetaFromValue<T> = 
  T extends readonly [any, infer Meta extends EnumerateValueMetadata] 
    ? Meta 
    : undefined;
