...
import {
  createValueFeature,
  createMetadataValueFeature,
} from "@/core/processors/value-features";
...
describe("Value Processors", () => {
  ...
  describe("createMetadataValueFeature", () => {
    test("should create feature with metadata", () => {
      const feature = createMetadataValueFeature([
        "active",
...
describe("Object Processors", () => {
  describe("createObjectFeature", () => {
    ...
    test("should have containsOneOf - callback variant", () => {
      ...
      expect(feature.containsOneOf("a", (o: typeof obj) => [o.A, o.B])).toBe(
        true,
      );
      expect(feature.containsOneOf("c", (o: typeof obj) => [o.A, o.B])).toBe(
        false,
      );
