...
test('ObjectGenerator - should generate ValueFeature for simple values', () => {
  ...
  expectTypeOf<Generated['INACTIVE']>().toEqualTypeOf<ValueFeature<'inactive'>>();
});
...
test('ObjectGenerator - should recursively handle nested dictionaries', () => {
  ...
  expectTypeOf<Generated['STATUS']>().toEqualTypeOf<ObjectGenerator<{
    ACTIVE: 'active';
    INACTIVE: 'inactive';
  }>>();

  expectTypeOf<Generated['STATUS']['ACTIVE']>().toEqualTypeOf<ValueFeature<'active'>>();
});
...
test('ObjectGenerator - should handle mixed nested and flat values', () => {
  ...
  expectTypeOf<Generated['NESTED']>().toEqualTypeOf<ObjectGenerator<{
    INNER1: 'inner1';
    INNER2: 'inner2';
  }>>();
...
test('ObjectGenerator - should handle deep nesting (3 levels)', () => {
  ...
  expectTypeOf<Generated['LEVEL1']['LEVEL2']['LEVEL3']>()
    .toEqualTypeOf<ValueFeature<'deep-value'>>();
});
...
test('ObjectGenerator - should handle complex real-world scenario', () => {
  ...
  expectTypeOf<Generated['CLIENT_ERROR']['NOT_FOUND']>().toEqualTypeOf<ValueFeature<404>>();
  expectTypeOf<Generated['SERVER_ERROR']['INTERNAL']>().toEqualTypeOf<ValueFeature<500>>();
